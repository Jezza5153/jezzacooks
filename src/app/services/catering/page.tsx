...
const faqs = [
  ...
  {
    q: "Wat is jullie annulerings- en wijzigingsbeleid voor catering?",
    a: "Het annuleringsbeleid is afgestemd op event-grootte en de inkoop-aanlooptijd die daarvoor nodig is. Voor kantoorlunch (10-30 personen): kosteloos annuleren tot 24 uur vooraf, daarna 50% van het offertebedrag verschuldigd. Voor diners en events tot 80 personen: kosteloos tot 7 dagen vooraf, 50% binnen 7 dagen, 100% binnen 48 uur. Voor grote events (80-150+ personen): kosteloos tot 14 dagen vooraf, 50% binnen 14 dagen, 75% binnen 7 dagen, 100% binnen 48 uur. Wijzigingen in aantallen volgen een ander schema (zie de FAQ over headcount-wijzigingen): tot 72 uur vooraf max 15% verhoging of verlaging gratis, daarna prorata. Force majeure-clausule: bij overheidsmaatregelen (lockdown, evenementenstop) of zware ziekte gedocumenteerd met dokter-verklaring herzien we het bedrag in goed overleg. Aanbetaling 25% bij bevestiging is altijd terugvorderbaar tot 14 dagen vooraf bij events boven 30 personen. Volledige offerte-tekst staat op de offerte zelf.",
  },
  {
    q: "Welke verzekeringen en certificeringen heeft Tafelaar × Jezza Cooks Catering?",
    a: "Drie laagjes dekking. (1) HACCP-conform: alle keukenprocessen volgen de vereiste sanitatie-, temperatuur- en allergenen-protocollen — niet als declaratie maar als dagelijkse praktijk in restaurant De Tafelaar (Kamp 8) waar elke dienst geïnspecteerd wordt. (2) Bedrijfsaansprakelijkheidsverzekering via Jezza Cooks (KvK 99547619) en separaat via De Tafelaar Amersfoort B.V. — beide partijen zijn verzekerd voor materiële en lichamelijke schade tijdens cateringevenementen tot reguliere bedrijvenmarkt-niveaus. Polisnummers worden op verzoek aan opdrachtgever vrijgegeven voor procurement compliance. (3) Lidmaatschap Koninklijke Horeca Nederland (KHN) via De Tafelaar — geeft toegang tot HACCP-naleving audits en branche-richtlijnen. Daarnaast is een teamlid Leermeester-gecertificeerd (officiële Nederlandse erkenning voor leerbedrijven), wat impliceert dat het keukenteam zelf voldoet aan de hoogste opleidings- en hygiëne-standaarden. Voor opdrachtgevers met aanvullende eisen (allergenen-attestering per gerecht, batch-tracking, foto-documentatie van de mise en place) maken we afspraken op maat.",
  },
  {
    q: "Hoe ver buiten Amersfoort leveren jullie catering en wat is de reistoeslag?",
    a: "Het kerngebied is heel Amersfoort en alle wijken (Binnenstad, Kamp, Soesterkwartier, Leusderkwartier, Vathorst, Valleipoort, Kattenbroek, Randenbroek, Hoogland, Hooglanderveen, Liendert, Schothorst, Zielhorst) plus de buurgemeenten Soest, Leusden, Baarn, Bunschoten, Nijkerk en Barneveld. Daar leveren we standaard zonder reistoeslag op het basistarief; er gelden alleen bezorgkosten op grond van afstand vanaf de keuken aan de Kamp 8 (gratis vanaf 15 personen binnen Amersfoort centrum, €15 voor randwijken, €20-€35 voor buurgemeenten). Voor opdrachten buiten dat gebied — Utrecht (15-25 min rijden), Hilversum (25 min), Apeldoorn (40 min), Zwolle (50 min), Amsterdam-zuid (40 min), Rotterdam (75 min) — leveren we op afspraak met aangepaste levertijd, minimumafname vanaf 20 personen, plus een reistoeslag van €0,21 per kilometer (heen + terug) en een uurtarief van €45/uur voor reistijd boven 60 minuten enkele reis. Internationaal (België grensstreek, Duitsland-Aken-Düsseldorf as) op maat — contact op met details voor offerte.",
  },
];
