    ...
    <div className="flex flex-col">
      ...
      <section className="bg-primary text-primary-foreground py-16">
        <div className="container mx-auto px-4 text-center">
            ...
            <p className="mt-2 text-lg text-primary-foreground/80 max-w-2xl mx-auto">DM or WhatsApp <span className="font-bold">'SCAN'</span> for a free, no-strings-attached audit of your website or menu.</p>
      ...
      <section className="py-16 md:py-24">
        <div className="container mx-auto px-4 max-w-3xl">
          ...
          <div className="text-center mt-8">
            <Button variant="link" asChild>
                <Link href="/faq">More Questions? Visit FAQ <ArrowRight className="ml-2 h-4 w-4" /></Link>
            </Button>
          </div>
        </div>
      </section>
